...
const  SubSubcategoryDetails= () => {
    const router = useRouter()
    const subsubcategoryName = router.query.subSubCategory;
...
// console.log('product name test:',productName)
    ...
    subsubcategory_Name_Icontains:subsubcategoryName,
    ...
    return (
      <> 
        <Title>SubSub-Category Products</Title> 
         <Box> 
          ...
          <Container>
            ...
            <Box className={styles.products_section_title}>
              <Typography variant="body1" sx={{ fontSize: "20px" }}>
                ...
                <FontAwesomeIcon icon={faList} style={{color:'var(--primary)',fontSize:'20px'}} /> SubSubCategory :   {subsubcategoryName} 
              </Typography>
            </Box>
